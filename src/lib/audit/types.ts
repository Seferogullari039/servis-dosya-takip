...
export const AUDIT_ACTIONS = {
  ...
  WORK_ORDER_TYPE_CHANGED: "work_order.type_changed",
  WORK_ORDER_PAYMENT_STATUS: "work_order.payment_status_changed",
  WORK_ORDER_PAYMENT_AMOUNT: "work_order.payment_amount_changed",
  WORK_ORDER_CLOSED: "work_order.closed",
  WORK_ORDER_PAYMENT_NOTE: "work_order.payment_note_changed",
  SERVICE_FILE_INSURANCE: "service_file.insurance_changed",
...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  [AUDIT_ACTIONS.WORK_ORDER_TYPE_CHANGED]: "İş emri tipi değişikliği",
  [AUDIT_ACTIONS.WORK_ORDER_PAYMENT_STATUS]: "İş emri ödeme durumu değişikliği",
  [AUDIT_ACTIONS.WORK_ORDER_PAYMENT_AMOUNT]: "Tahsil edilen tutar değişikliği",
  [AUDIT_ACTIONS.WORK_ORDER_CLOSED]: "İş emri kapandı",
  [AUDIT_ACTIONS.WORK_ORDER_PAYMENT_NOTE]: "İş emri ödeme notu değişikliği",
  [AUDIT_ACTIONS.SERVICE_FILE_INSURANCE]: "Sigorta şirketi değişikliği",
